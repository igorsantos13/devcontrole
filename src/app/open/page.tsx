...
export default function OpenTicket() {
  ...
  return (
    <div className="w-full max-w-2xl mx-auto px-2 rounded bg-white">
      <h1 className="font-bold text-3xl text-center mt-24 text-black">
        Abrir chamado
      </h1>

      <main className="flex flex-col mt-4 mb-2">
        {customer ? (
          <div className="bg-slate-200 flex items-center justify-between py-6 px-4 rounded border-2">
          ...
          <form
            ...
            action=""
            className="bg-slate-200 py-6 px-2 rounded border-2 text-black"
          >
